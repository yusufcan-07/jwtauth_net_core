using JWTImplementation.Authentication;
...
namespace JWTImplementation.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel registerModel)
        {
            ...
            if (!result.Succeeded)
                return StatusCode(StatusCodes.Status500InternalServerError, new Response { Status = "Error", Message = "User creation failed. Please check and try again!" });
